...
como imagem. A ordem é verificada encadeando a última legenda de uma parte com a
primeira da seguinte.

## Tabela de partes

| Parte | Duração | Início acumulado | Fim acumulado | Conteúdo |
|---|---|---|---|---|
| 1 | 30,0s | 0:00,0 | 0:30,0 | Amin entrevistado à beira do rio ("líder mais influente da África"); entrada do apresentador; cartela "a verdade" |
| 2 | 36,0s | 0:30,0 | 1:06,0 | Kampala aérea; Amin de boina vermelha; Amin de terno gesticulando; retrato oficial fardado + crédito "Idi Amin Dada"; cartela 1971–1979 |
| 3 | 34,9s | 1:06,0 | 1:40,9 | Cartela "500 mil pessoas"; retrato de quepe vermelho sobre fundo verde; Amin com delegação árabe (P&B); Amin sobre blindado; menção a Milton Obote derrubado por golpe militar |
| 4 | 33,2s | 1:40,9 | 2:14,1 | Apresentador sobre os 300 mil oficiais e estimativa acima de 500 mil; mapa antigo da África; cerimônia colonial com bandeira de Uganda |
| 5 | 27,4s | 2:14,1 | 2:41,5 | Fotografia histórica emoldurada; apresentador sobre o legado ainda defendido por parte dos ugandenses e a imagem de libertador |
| 6 | 39,3s | 2:41,5 | 3:20,8 | Apresentador anuncia volta no tempo; **cartela de capítulo "A JUVENTUDE"**; nascimento no noroeste de Uganda, perto das fronteiras com Sudão e Congo; data nunca registrada, biógrafos apontam meados de 1925 |
| 7 | 23,0s | 3:20,8 | 3:43,8 | Pai agricultor, povo Kakwa (Uganda/Congo/Sudão); mãe do grupo Lugbara; comunidade núbia. B-roll atual: militar entre crianças, dançarinos, mulheres tecendo cestos |
...
Kakwa, mulheres tecendo — filmado hoje, não na época) e **ilustração gerada por
IA** (a aldeia da parte 6 é claramente sintética). Para o corte: usar IA ou
b-roll atual sob narração que fala de 1925 passa imagem falsa como arquivo.
Preferir sempre o arquivo real; se faltar, usar plano do apresentador.

**3 · As legendas do documentário têm erros de transcrição** — o povo Kakwa vira
"Cáa", o suaíli vira "quisoar", Obote vira "Obotê", Idi Amin vira "Idiamin" e
"Ediamin". A leitura é minha, então corrijo na hora de escrever a narração.

## Bloco B1 (origem e carreira militar) — material já localizado

| Parte | Segundo dentro da parte | Plano |
|---|---|---|
| 9 | ~4s a ~12s | Tropas coloniais britânicas em combate, P&B |
| 9 | ~14s a ~20s | Amin de quepe em formatura, entre oficiais |
| 10 | ~13s a ~18s | Amin nadando em piscina, com outros recrutas |
| 10 | ~19s a ~28s | Retratos de Amin boxeador, luvas, P&B |
| 10 | ~29s a ~34s | Amin com o cinturão, cercado de dirigentes |
| 8 | ~22s a ~30s | Retrato colorido, quepe vermelho, olhar de frente |

## Planos fortes já identificados

| Onde | Plano | Uso provável |
|---|---|---|
| Parte 2 | Amin de boina vermelha, tratamento em vermelho | Hook (B0) |
| Parte 3 | Retrato de quepe vermelho, fundo verde, olhar fixo | Freeze do B0 ou do B8 (legado) |
| Parte 2 | Retrato oficial fardado sentado, com crédito na tela | Freeze do B5 (imagem pública) |
| Parte 3 | Amin em cima de blindado, tropas ao redor | B2 (golpe) ou B7 (queda) |
| Parte 4 | Cerimônia colonial com bandeira | B1 (independência 1962) |
| Parte 3 | Amin com delegação árabe, P&B | B5 (relações externas) |
