...
SPEC=[
 ( 10,108,"ISSO AQUI","É SÓ 1 DE 6.",380,760,0.760),  # sobre a comida
 (192,250, None,      "6 CHURRASQUEIRAS.",  0,900,0.205), # sobre o ceu, no reveal
 (254,312, None,      "AO MESMO TEMPO.",    0,840,0.205),
]
...
LOCK=560
OUT="tx"; shutil.rmtree(OUT,ignore_errors=True); os.makedirs(OUT)
